...
//
//    /**
//     * Retrieve the single instance of this loader
//     *
...
//
//    /**
//     * Get a cursor based on a image reference on the class path
//     *
...
//     * @throws RuntimeException Indicates a failure to create the hardware cursor
//     */
//    public Cursor getCursor(String ref, int x, int y) throws IOException, RuntimeException {
...
//     * @throws RuntimeException Indicates a failure to create the hardware cursor
//     */
//    public Cursor getCursor(ByteBuffer buf, int x, int y, int width, int height) throws IOException, RuntimeException {
//        for (int i = 0; i < buf.limit(); i += 4) {
//            byte red = buf.get(i);
//            byte green = buf.get(i + 1);
//            byte blue = buf.get(i + 2);
...
//     * @throws RuntimeException Indicates a failure to create the hardware cursor
//     */
//    public Cursor getCursor(ImageData imageData, int x, int y) throws IOException, RuntimeException {
