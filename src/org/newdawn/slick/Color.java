...
public class Color implements Serializable {
     ...
     * Copy constructor
     *
     * @param color The colour to copy into the new instance
     */
     ...
     *
     * @param buffer The buffer to read the colour from
     */
    ...
    public Color(int value) {
        int lr = (value & 0x00FF0000) >> 16;
        int lg = (value & 0x0000FF00) >> 8;
        int lb = (value & 0x000000FF);
        int la = (value & 0xFF000000) >> 24;
     ...
     * @return The colour generated from the number read
     */
    ...
    /**
     * Multiply this colour by another
     *
     * @param c the other colour
     * @return product of the two colours
     */
     ...
     *
     * @param c The colour to add
     * @return The copy which has had the colour added to it
     */
