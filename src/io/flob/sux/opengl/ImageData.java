...
public interface ImageData {
     ...
     *
     * @return Get the last width in pixels read from a TGA
     */
    public int getWidth();
     ...
     *
     * @return Get the last height in pixels read from a TGA
     */
     ...
     *
     * @return Get the last required texture width for a loaded image
     */
    public int getTexWidth();

    /**
     * Get the last required texture height for a loaded image
     *
     * @return Get the last required texture height for a loaded image
     */
