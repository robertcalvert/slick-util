 ...
 *
 * Fresh cut of code but largely influenced by the TGA loading class provided as
 * part of the Java Monkey Engine (JME). Why not check out what they're doing
...
public class TGAImageData implements LoadableImageData {
    ...
    public ByteBuffer loadImage(InputStream fis, boolean flipped, boolean forceAlpha, int[] transparent) throws IOException {
        ...
        if (imageType != 2) {
            throw new IOException("SUX only supports uncompressed RGB(A) TGA images");
        }
